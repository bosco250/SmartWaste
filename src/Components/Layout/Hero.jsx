...
const Hero = () => {
  return (
    <div className="bg-[#184b41] text-white min-h-screen px-8 flex  justify-center items-center pt-[10vh] md:pt-[13vh] ">
      <div className="flex flex-col items-center justify-center text-center md:w-3/4">
      <h1 className="md:text-4xl text-3xl font-bold mb-10 w-4/5">Optimize Waste Management with SmartWaste</h1>
